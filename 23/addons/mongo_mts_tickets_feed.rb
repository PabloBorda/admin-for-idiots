...

{
  ...
  :helper_methods_exposed_to_url => [{:find_ticket_feed => Proc.new {
                                                             ...
                                                             my_session = Marshal.load((session[:feed_sessions].select {|s| s[:name].eql?  'mongo_mts_tickets_feed'}).first)
                                                             puts my_session[:name]
                                                             coll = my_session[:session]['mts-tickets-indexed-by-paragraph']
