...
var $ac =  $("#autocomplete1").autocomplete({
        ...
        $ac.data("ui-autocomplete")._renderItem = function(ul, item) {
          ...
          var fork_note = "<button name=\"fork\" onclick=\"fork_note('" + item.ticket_number  + "','" + item.note_number + "')\">Fork note</button>";
          var view_ticket = "<button name=\"fork\" onclick=\"view_ticket('" + item.ticket_number  + "','" + item.note_number + "')\">View Ticket</button>";



          var markup = "<table class=\"autocomplete-element\" width=\"100%\">" + 
                          "<tr>" + 
                            "<td>" +
                              "<table>" + 
                                "<tr><td>" + 
                            ...
                            "<td>" + 
                              ...
                              "</span>" + 
                            "</td>" + 
                            "<td class=\"pics\" align=\"right\">" +  
                              "<img src=\"http://myhub.corp.ebay.com/User%20Photos/Profile%20Pictures/_w/corp_" + item.mr.toString() + "_LThumb_jpg.jpg\"/>" +  
                            "</td>" + 
                          "</tr>" +
                      "</table>";
