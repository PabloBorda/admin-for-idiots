...
var $ac =  $("#autocomplete1").autocomplete({
        ...
        $ac.data("ui-autocomplete")._renderItem = function(ul, item) {
          ...
          var markup = "<table class=\"autocomplete-element \"width=\"100%\"><tr><td><span class=\"knows\">" + text_highlighted + "</span></td><td class=\"pics\" align=\"right\"><img src=\"http://myhub.corp.ebay.com/User%20Photos/Profile%20Pictures/_w/corp_" + item.mr.toString() + "_LThumb_jpg.jpg\"/></td></tr></table>";
