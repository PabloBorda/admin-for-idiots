...
# =========================================JIRA FEED==========================================
      j = Datafeed::Jirafeed.new
      my_bug_links = j.jira_search(findstr)
     ...
     puts "SUGGESTIONS FOR JIRA " + suggestions_for_jira.to_json



     @suggestions = @suggestions + suggestions_for_jira
#========================================END JIRA FEED===========================================



#============================DEVELOPER.PAYPAL.COM GOOGLE SEARCH FEED ============================
